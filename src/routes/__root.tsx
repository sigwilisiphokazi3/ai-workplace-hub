  ...
  head: () => ({
    meta: [
      ...
      { title: "Workmate AI — Workplace Productivity Assistant" },
      {
        name: "description",
        content:
          "AI-powered workplace productivity suite: smart emails, meeting summaries, task planning, research, and an AI assistant chat.",
      },
      ...
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/ae96d6b7-fd98-49fa-9c3c-4e6ff69351d6/id-preview-f64002c6--5ceb8d07-18dd-4381-8d99-cc37bd7ea720.lovable.app-1780562672946.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/ae96d6b7-fd98-49fa-9c3c-4e6ff69351d6/id-preview-f64002c6--5ceb8d07-18dd-4381-8d99-cc37bd7ea720.lovable.app-1780562672946.png" },
          ...
          <SidebarInset className="flex min-w-0 flex-1 flex-col">
            <header className="sticky top-0 z-30 flex h-14 items-center gap-2 border-b bg-background/80 px-4 backdrop-blur-md">
              ...
              <div className="ml-auto flex items-center gap-2 text-xs text-muted-foreground">
                ...
                <span className="hidden sm:inline">AI services online</span>
              </div>
            </header>
